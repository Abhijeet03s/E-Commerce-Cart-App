export default function Card({ id, title, price, image, category, description, addToCart }) {
    ...
    return (
        <div className="p-5">
            <div className="flex flex-col justify-between w-96 h-96 overflow-hidden rounded-lg shadow-lg bg-white box-shadows">
                ...
                <p className="text-md pl-2 capitalize font-bold text-black">Category:{category}</p>
                {/* <div className="hover:">
                    <p class="text-center mt-1 text-sm text-gray-600 dark:text-gray-400">{description}</p>
                </div> */}
